...
public abstract class PositionedShape implements Shape, Serializable {
	...
	public boolean overlays(final PositionedShape shape) {
		return (this == null || shape == null) ? false : getOverlayedSurface(shape) > 0.0f;
	}
	
	public float getOverlayedSurface(final PositionedShape shape) {
		return (this == null || shape == null) ? 0 : xIntersectionLength(shape) * yIntersectionLength(shape);
	}
	
	protected float xIntersectionLength(final PositionedShape shape) {
		return (this == null || shape == null) ? 0 : intersectionLength(getxCoordinate(), getWidth(), shape.getxCoordinate(), shape.getWidth());
	}

	protected float yIntersectionLength(final PositionedShape shape) {
		return (this == null || shape == null) ? 0 : intersectionLength(getyCoordinate(), getHeight(), shape.getyCoordinate(), shape.getHeight());
	}
	...
	public int getxCoordinate() {
		return this == null ? -1 : getPosition().getxCoordinate();
	}
	...
	public int getyCoordinate() {
		return this == null ? -1 : getPosition().getyCoordinate();
	}
